...
import { ProjectDashboard } from './group-activity/ProjectDashboard'
import { KanbanBoard } from './group-activity/KanbanBoard'

interface GroupActivityContentProps {
  groupId?: string
  studentName?: string
}

export function GroupActivityContent({ groupId = 'demo-group', studentName = '홍길동' }: GroupActivityContentProps) {
...
function CalendarView({ project }: { project: any }) {
  return (
...
function FilesView({ project }: { project: any }) {
...
function DiscussionView({ project }: { project: any }) {
